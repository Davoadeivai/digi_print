...
const apiClient = new ApiClient({
  baseURL: '/api/v1',  // Django REST API base URL
  timeout: 10000,
  headers: {
    'Content-Type': 'application/json',
...
export class AuthService {
  ...
  static async getCurrentUser() {
    return apiClient.get(API_ENDPOINTS.AUTH.USER);
  }
}

export class ServiceService {
  static async getServices(params?: PaginationParams) {
    return apiClient.get<PaginatedResponse<any>>(API_ENDPOINTS.SERVICES.LIST, params);
  }
